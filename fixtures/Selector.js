...
// หน้าเมนูหลัก CIS ค้นหาลูกค้า
  ...
  SELECTOR_CIS_MENU_SUB_1_SEARCH_1_In_Page_19_Button: '#tab\\/cisapp_customer\\/search > div > div > div > div:nth-child(1) > div > div.MuiCollapse-container.MuiCollapse-entered > div > div > div > div > form > div > div > div > div > div > div:nth-child(2) > div > div > div > div > div > div:nth-child(2) > button',
